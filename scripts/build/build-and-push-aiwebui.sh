...
# Build and push aiwebui image to GitHub Container Registry
# Usage: ./build-and-push-aiwebui.sh [VERSION] [--force]
# Example: ./build-and-push-aiwebui.sh v2.1.5
# Example with force: ./build-and-push-aiwebui.sh v2.1.5 --force
...
# Main execution
main() {
    print_header "AI Web UI - Build & Push"
