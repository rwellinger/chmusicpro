...
# Build and push chmusicprosrv images to GitHub Container Registry
# Usage: ./build-and-push-chmusicprosrv.sh [VERSION] [--force]
# Example: ./build-and-push-chmusicprosrv.sh v2.1.5
# Example with force: ./build-and-push-chmusicprosrv.sh v2.1.5 --force
...
APP_IMAGE="chmusicprosrv-app"
PROJECT_DIR="$(cd "$(dirname "$0")/../.." && pwd)"
BUILD_DIR="$PROJECT_DIR/chmusicprosrv"
FORCE_PUSH=false
...
# Main execution
main() {
    print_header "CH Music Pro Service - Build & Push"
