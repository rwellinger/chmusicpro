...
def get_version() -> str:
    ...
    try:
        # Path from src/api/app.py to chmusicprosrv root (2 levels up)
...
def create_app():
    ...
    spec = APISpec(
        title="thWelly's Song Production API",
        version=get_version(),
        openapi_version="3.0.2",
        info={
            "description": "API für AI-Services: Bildgenerierung, Musikgenerierung und Chat-Integration",
            "contact": {"name": "rwellinger", "url": "https://github.com/rwellinger/chmusicpro"},
        },
